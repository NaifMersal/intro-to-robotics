...
<iframe src="https://wokwi.com/projects/460363431768902657" width="100%" height="520px" style="border:none; border-radius:12px;" allowfullscreen></iframe>
...
2. **Print the Value**: Use `Serial.println(brightness);` in `loop()`.
...
<iframe src="https://wokwi.com/projects/460387279699213313/embed"
