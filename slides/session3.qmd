...
1. **Trigger:** Arduino sends a 10µs pulse.
2. **Sonic Burst:** Sensor sends an 8-cycle burst of 40kHz sound.
3. **Echo:** Sensor returns an electrical pulse to Arduino.
   - *Pulse duration = round-trip travel time!*

:::

::: {.column width="50%"}
::: {.callout-tip}
**Speaker & Microphone Analogy**

- **Trig (Speaker):** Arduino OUTPUTS a command.
- **Echo (Mic):** Arduino INPUTS the reply.
:::
:::
:::
